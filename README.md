...
| Text chat and online status | Not yet | Not built. Designed: a small XMPP server, which also shows players as online. Use Discord meanwhile |
...
- **Parties, friends and guilds** (server side, not yet tried with two real game clients): invites,
